...
const projectsData = [
  ...
  {
    id: 'farm-vehicle',
    title: 'AI Based multi-crop health monitoring autonomous device',
    ...
    fullDetails: {
      overview: 'Designed and developed a concept model of an Automated Pesticide Spraying Robot aimed at reducing human exposure to harmful pesticides in agricultural fields. The project focused on remote-controlled spraying operations using an Arduino-based control system, improving farmer safety, efficiency, and crop productivity through intelligent automation.',
      tools: ['SolidWorks', 'Arduino Uno', 'Bluetooth Android Application'],
      engineeringContributions: [
        'Designed the full robot structure and body layout using SolidWorks CAD modeling',
        'Developed the locomotion system using DC geared motors for off-road agricultural terrain',
        'Designed and integrated the pesticide spraying mechanism for uniform coverage',
        'Implemented direction and speed control using motor drivers and servo motors',
        'Programmed remote operation via Bluetooth-enabled Android application',
        'Designed the power supply system using battery pack and DC-DC converter',
        'Validated the concept model against real-world agricultural use cases'
      ],
      technicalSkills: [
        '3D CAD Modeling (SolidWorks)',
        'Embedded Systems & Arduino Programming',
        'DC Motor & Servo Motor Control',
        'Bluetooth-Based Remote Communication',
        'Agricultural Automation & Robotics Concepts',
        'Power Electronics (Battery & DC-DC Converter Design)'
      ],
      keyLearnings: [
        'Understanding of autonomous and remote-controlled vehicle design principles',
        'Motor selection and torque calculation for rough terrain locomotion',
        'Importance of spray nozzle placement for optimal pesticide distribution',
        'Practical exposure to embedded control systems and wireless communication',
        'Integration of mechanical design with electronics for a functional prototype'
      ],
      challenges: [
        { challenge: 'Terrain Mobility', solution: 'Designed large-diameter wheels with wide tread for stable off-road movement' },
        { challenge: 'Spray Uniformity', solution: 'Optimized nozzle positioning and spray angle in the CAD model' },
        { challenge: 'Power Management', solution: 'Integrated DC-DC converter to regulate voltage for consistent motor performance' },
        { challenge: 'Control Stability', solution: 'Used servo motors for precise directional control during operation' }
      ],
      outcome: 'Successfully developed a SolidWorks concept model demonstrating the full working principle and design approach. Demonstrated feasibility of remote-controlled pesticide spraying for real-world agricultural fields. Gained hands-on understanding of agricultural robotics, embedded systems, and mechatronic integration.',
      gallery: ['/farm-vehicle.jpg', '/farm-vehicle-cad-1.jpg', '/farm-vehicle-cad-2.jpg']
    }
  },
  {
